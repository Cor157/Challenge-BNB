                ...
                <div class="homes-box">
                    <?php if (isset($database_gegevens) && $database_gegevens != null) : ?>
                        <?php foreach ($database_gegevens as $huisje) : ?>
                           ...
                           Prijs per Nacht  €  <?php echo $huisje['price_p_p_p_n']; ?> ,-
                           </h4>
                            <h4>
                             Prijs per Bed sheets    <?php echo $huisje['price_bed_sheets']; ?> 
...
<div class="book">
    <form method="get" action="">
         ...
         <?php
         if (isset($_GET['huisje'])){
            echo "totalPrice " .$_GET['aantal_personen'] * $huisje['price_p_p_p_n'];
